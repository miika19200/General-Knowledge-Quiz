...
#question 5
    ...
    print("\nQuestion: 1 | score: {}".format(score))
    ans=input("What’s the most expensive home in the world?\na.Antilia, Mumbai\nb.Buckland Palace\nc.Villa Leopolda, Villefranche-sur-Mer\n=>")
    if ans == 'Buckingham Palace' or ans == 'buckland palace or ans == 'b' or ans == 'B':
        print('Correct')
        score +=1
        print("your score is",score)
    else:
        ...
        if score <=0:
            score =0
        print("Incorrect the answer is Buckland Palace")
